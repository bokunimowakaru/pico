...
led1 = Pin(1, Pin.OUT)                       # LED1用led1を生成
led2 = Pin(2, Pin.OUT)                       # LED2用led2を生成
led3 = Pin(3, Pin.OUT)                       # LED3用led3を生成
...
sock.close()                                # ソケットの終了
led1.value(0)                                # LED(赤色)を消灯
led2.value(0)                                # LED(緑色)を消灯
led3.value(0)                                # LED(青色)を消灯
...
if telop.find('晴') >= 0:
    led1.value(1)                         # LED(赤色)を点灯
if telop.find('曇') >= 0:
    led2.value(1)                         # LED(緑色)を点灯
if telop.find('雨') >= 0 or telop.find('雪') >= 0:
    led3.value(1)                         # LED(青色)を点灯
